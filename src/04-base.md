...
<h2>Сравнение с Пионером Мини 2</h2>
...
<tr><td>Pioneer-SDK2 (Python)</td><td>✅ из коробки</td><td>✅ с модулем Radxa Zero / Pi Zero 2W</td></tr>
...
<h2>Программирование Базового</h2>
<h3>Python</h3>
<p>Для работы с «Базовым» используются те же библиотеки, что и для всей серии «Пионер»:</p>
<div class="codewrap"><pre><code data-lang="bash">pip install pioneer_sdk   # первая версия SDK — для любого оборудования, кроме модуля Pi Zero 2W
pip install pioneer_sdk2  # вторая версия SDK — только для модуля Pi Zero 2W</code></pre></div>
...
<h3>Lua и Trik Studio</h3>
<p>Как и Мини 2, «Базовый» программируется Lua-скриптами на автопилоте (см. <a href="/07-lua/">справочник Lua</a>) и в визуальной среде Trik Studio (<a href="/08-blocks/">блочное программирование</a>).</p>
...
<h2>Характеристики и распиновка</h2>
<p>Ниже — данные из официального раздела «Технические характеристики и комплект поставки».</p>

<section class="docblock"><p>Быстрый старт</p>
<p>Научитесь выполнять подготовку квадрокоптера, изучите доступные способы управления и совершите свой первый полет!</p>
<h3 id="s-основные-характеристики"><a class="anchor" href="#s-основные-характеристики" aria-hidden="true">§</a>Основные характеристики</h3>
<div class="tablewrap"><table><thead><tr><th>Тип беспилотного летательного аппарата</th><th>мультироторный</th></tr></thead><tbody><tr><td>Воздушная скорость</td><td>до 65 км/ч</td></tr><tr><td>Продолжительность полета</td><td>до 17 мин</td></tr><tr><td>Масса полезной нагрузки</td><td>150 грамм</td></tr><tr><td>Максимальный взлетный вес</td><td>420 грамм</td></tr><tr><td>Рабочий диапазон температур</td><td>от -10 до +40 °С</td></tr><tr><td>Диаметр воздушных винтов</td><td>127 мм gemfan 5030</td></tr><tr><td>Расстояние между двигателями</td><td>190 мм по диагонали</td></tr><tr><td>Размеры в сборе</td><td>290 × 290 × 120 мм</td></tr></tbody></table></div>
<h3 id="s-возможности"><a class="anchor" href="#s-возможности" aria-hidden="true">§</a>Возможности</h3>
<div class="tablewrap"><table><thead><tr><th>Управление через мобильное приложение</th><th>Jump* (Android)</th></tr></thead><tbody><tr><td>Управление через пульт РУ</td><td>да</td></tr><tr><td>Поддержка систем навигации</td><td>оптическая (OPT), инфракрасная (ИК), ультразвуковая (УЗ), спутниковая (GPS)</td></tr><tr><td>Поддержка языков программирования</td><td>Python, Lua</td></tr><tr><td>Поддержка блочного программирования</td><td>Jump*, Trik Studio (Lua)</td></tr></tbody></table></div>
<p>*Требуется модуль esp32.</p>
<h3 id="s-двигатели"><a class="anchor" href="#s-двигатели" aria-hidden="true">§</a>Двигатели</h3>
<div class="tablewrap"><table><thead><tr><th>Тип двигателей</th><th>электрические бесколлекторные</th><th>Flash Hobby BX1306-3100KV</th></tr></thead><tbody><tr><td>Диаметр двигателя</td><td>18</td><td>мм</td></tr><tr><td>Высота двигателя</td><td>29.1</td><td>мм</td></tr><tr><td>Диаметр вала</td><td>2</td><td>мм</td></tr></tbody></table></div>
<h3 id="s-модуль-расширения"><a class="anchor" href="#s-модуль-расширения" aria-hidden="true">§</a>Модуль расширения</h3>
<div class="tablewrap"><table><thead><tr><th>Дальномер</th><th>лазерный</th></tr></thead><tbody><tr><td>Камера</td><td>оптический поток</td></tr></tbody></table></div>
<h3 id="s-аккумуляторная-батарея"><a class="anchor" href="#s-аккумуляторная-батарея" aria-hidden="true">§</a>Аккумуляторная батарея</h3>
<div class="tablewrap"><table><thead><tr><th>Тип АКБ</th><th>Li-Po</th></tr></thead><tbody><tr><td>Количество ячеек АКБ</td><td>2S</td></tr><tr><td>Номинальное напряжение на ячейку</td><td>3.7 Вольт</td></tr><tr><td>Суммарное напряжение</td><td>6.4-8.4 Вольт</td></tr><tr><td>Токоотдача</td><td>40-45 C</td></tr><tr><td>Емкость</td><td>1800 мА/ч</td></tr><tr><td>Масса</td><td>≈130 грамм</td></tr><tr><td>Размеры</td><td>90 × 34 × 14 мм</td></tr><tr><td>Рекомендуемая сила тока зарядки</td><td>Не более 1C (1.8А) Ампер</td></tr></tbody></table></div>
<h3 id="s-распиновка"><a class="anchor" href="#s-распиновка" aria-hidden="true">§</a>Распиновка</h3>
...
<h3 id="s-комплект-поставки"><a class="anchor" href="#s-комплект-поставки" aria-hidden="true">§</a>Комплект поставки</h3>
<div class="tablewrap"><table><thead><tr><th>Плата автопилота</th><th>1 шт</th></tr></thead><tbody><tr><td>Плата-адаптер</td><td>1 шт</td></tr><tr><td>Шлейф</td><td>2 шт 10 pin + 12 pin</td></tr><tr><td>Радиоприемник</td><td>1 шт FS-A8S</td></tr><tr><td>Кабельная сборка радиоприемника</td><td>1 шт Коннекторы PicoBlade 1.25 мм, 3 pin и 4 pin</td></tr><tr><td>Основание рамы</td><td>1 шт</td></tr><tr><td>Посадочные ножки</td><td>2 шт 1 верхняя + 1 нижняя</td></tr><tr><td>Торец отсека АКБ</td><td>1 шт</td></tr><tr><td>Основание защиты винтов</td><td>4 шт</td></tr><tr><td>Прямая защиты винтов</td><td>8 шт</td></tr><tr><td>Дуга защиты винтов</td><td>8 шт</td></tr><tr><td>Двигатель</td><td>4 шт 2 (черная шайба) + 2 (белая шайба)</td></tr><tr><td>Пропеллер</td><td>4 шт 2 (правое вращение) + 2 (левое вращение)</td></tr><tr><td>Винт М2х4</td><td>8 шт DIN 912 M2 х 4</td></tr><tr><td>Винт М2х6</td><td>8 шт DIN 912 M2 х 6</td></tr><tr><td>Винт М3х4</td><td>4 шт</td></tr><tr><td>Винт М3х5</td><td>4 шт</td></tr><tr><td>Винт М3х10</td><td>24 шт</td></tr><tr><td>Стойка демпферная</td><td>4 шт</td></tr><tr><td>Стойка М3х8</td><td>8 шт</td></tr><tr><td>Стойка М3х25</td><td>16 шт</td></tr><tr><td>Аккумуляторная батарея</td><td>1 шт</td></tr><tr><td>Кабель USB</td><td>1 шт</td></tr><tr><td>Отвертка</td><td>1 шт</td></tr><tr><td>Руководство по эксплуатации</td><td>1 шт</td></tr><tr><td>Технический паспорт</td><td>1 шт</td></tr></tbody></table></div>
...
<div class="tablewrap"><table><thead><tr><th>Коннектор X7</th><th>Назначение</th></tr></thead><tbody><tr><td>1</td><td>+5V</td></tr><tr><td>2</td><td>GND</td></tr><tr><td>3</td><td>-</td></tr></tbody></table></div>
<p>*Комплект поставки может отличаться в зависимости от года поставки и особых договоренностей в контракте.</p>
<div class="tablewrap"><table><thead><tr><th>Коннектор X6</th><th>Назначение</th></tr></thead><tbody><tr><td>1</td><td>RST</td></tr><tr><td>2</td><td>BOOT0</td></tr><tr><td>3</td><td>SYNC</td></tr><tr><td>4</td><td>P9</td></tr><tr><td>5</td><td>P8 (I2C_SDA)</td></tr><tr><td>6</td><td>P7 (I2C_SCL)</td></tr><tr><td>7</td><td>VIN</td></tr><tr><td>8</td><td>GND</td></tr></tbody></table></div></section>
